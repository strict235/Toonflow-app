...
description: 海外短剧约束 — 定义韩式网漫二次元动画在色调体系、光影方案、质感方向、场景空间元素、配乐选择与环境音上的全局约束。适用于任何叙事类型。
metaData: director_skills
---

# 海外短剧约束 · 韩式网漫二次元动画 · 技法参考
...
- **色盘先行原则** — 段落规划需先绑定情绪场景（冲突升级/情感转折/高潮对峙/和解释怀/悬念钩子/竖屏特写段落等），再确定主色+辅色与光影方案，避免"剧情对了但情绪不对色"
...
- **网漫柔光渐变光影特征** — 清晰的明暗分界线、戏剧化低调光影为核心手段；光影必须服务于情绪叙事，保持二次元动画的网漫柔光渐变上色风格
...
- **网漫柔光渐变为锚** — 韩式网漫二次元动画的核心：清晰线条、网漫柔光渐变上色、戏剧化低调光影，呈现电影级二次元动画画面
- **面容与皮肤** — 面容细腻渲染、皮肤细腻、五官精致；女性冷白肤（C1）通透不惨白，男性暖白肤（C2）清爽自然。肌肤保持网漫柔光渐变质感的平滑细腻
- **服饰材质** — 衣物布料质感清晰、纹理细节超清晰、布料折痕真实、衣物随动态飘逸。国际化现代场景服饰（西装/衬衫/连衣裙/大衣）的面料质感须可信
- **场景材质** — 场景材质纹理清晰、空气透视、现代使用痕迹、生活气息。玻璃反光、金属光泽、木质纹理、布艺垂感均需在网漫柔光渐变风格下清晰呈现
- **网漫柔光渐变不等于扁平** — 韩式网漫二次元动画强调在网漫柔光渐变上色基础上叠加电影级光影与景深虚化，通过构图与情绪设计放大感染力，而非依赖写实堆砌

---

## 四、都市场景空间元素

国际化现代场景世界观特有的场景元素及其视觉叙事功能：

- **落地窗/玻璃隔断/门框** — 天然的框架式构图道具，制造"看不透"的层次感与空间纵深。玻璃的反光与透射是画面亮点
- **城市天际线/街道/公园** — 留白构图的天然载体，景即情：繁华街景 = 孤独中的喧嚣、雨中独坐长椅 = 孤寂、落叶飘过街道 = 离愁
- **灯光/窗光/屏幕光** — 国际化现代场景的光源载体，室内暖灯 = 暖/私密（方案D）、城市夜景 = 冷暖交织（方案F）、自然窗光 = 日常/静谧（方案E）
...
- **电子氛围音** — 低频电子pad用于城市空镜/孤独段落的氛围铺底，增加国际化现代场景的空间感
