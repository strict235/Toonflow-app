...
4. **现代硬边赛璐璐为锚** — 所有画面以现代日系动画风格为标准，强调清晰线条与现代硬边赛璐璐上色
...
| R5 | 场景图中**严禁出现任何人物** |
| R6 | 必须包含「现代日系动画风格」关键词（anime style / cel shading） |
| R7 | 必须包含景深特征（shallow depth of field / vignette 至少一项），保持动画现代硬边赛璐璐风格 |
