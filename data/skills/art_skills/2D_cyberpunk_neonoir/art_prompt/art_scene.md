...
4. **霓虹赛璐璐为锚** — 所有画面以二次元动画风格为标准，强调清晰线条与霓虹赛璐璐上色
...
| 维度 | 约束 | 提示词 |
|---|---|---|
| 风格 | 赛博朋克都市家居/办公室/咖啡厅/公寓 | 现代{场景类型}风格 |
...
| R7 | 必须包含景深特征（shallow depth of field / vignette 至少一项），保持动画霓虹赛璐璐风格 |
