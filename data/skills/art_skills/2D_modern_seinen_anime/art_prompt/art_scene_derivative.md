...
5. **现代硬边赛璐璐为锚** — 所有变体必须保持现代日系动画风格，保持清晰线条与现代硬边赛璐璐上色
...
| R8 | 必须包含「现代日系动画风格」关键词（anime style / cel shading） |
| R9 | 必须包含景深特征（shallow depth of field / vignette 至少一项），保持动画现代硬边赛璐璐风格 |
