...
4. **网漫柔光渐变为锚** — 所有画面以韩式网漫风格为标准，强调清晰线条与网漫柔光渐变上色
...
| 维度 | 约束 | 提示词 |
|---|---|---|
| 风格 | 国际化现代场景家居/办公室/咖啡厅/公寓 | 现代{场景类型}风格 |
...
| R5 | 场景图中**严禁出现任何人物** |
| R6 | 必须包含「韩式网漫风格」关键词（anime style / cel shading） |
| R7 | 必须包含景深特征（shallow depth of field / vignette 至少一项），保持动画网漫柔光渐变风格 |
