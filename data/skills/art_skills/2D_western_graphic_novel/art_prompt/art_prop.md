...
| R4 | 必须包含「欧美漫画风格」关键词（anime style / cel shading） |
| R5 | 必须包含景深特征（shallow depth of field / vignette 至少一项），保持动画网点/Ink风格 |
