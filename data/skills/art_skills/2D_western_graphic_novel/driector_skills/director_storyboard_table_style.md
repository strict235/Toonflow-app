...
description: 分镜表海外短剧约束 — 定义欧美图像小说二次元动画在分镜表中的光影氛围规范、网点/Ink质感、动作节奏、环境动态、运镜禁忌与转场禁忌。适用于任何叙事类型。
metaData: director_skills
---

# 分镜表海外短剧约束 · 欧美图像小说二次元动画 · 技法参考

---

## 一、分镜表定位

分镜表是导演将剧本转化为镜头语言的核心工具。以下仅提供欧美图像小说欧美漫画风格在分镜表层面的约束规范。
...
- **网点/Ink动态表现** — 环境动态应符合二次元动画的表现方式：光影斑驳的手绘质感、布料飘动的线条美感、雨丝与灯光的网点/Ink渲染效果

---

## 四、都市人物动作节奏

- **动作要克制** — 欧美图像小说角色的动作应内敛含蓄，情绪不外放。关键动作（转身、抬手、回眸）标注"缓慢"或"从容"
...
- **禁用快速运镜** — 甩镜、急推、手持晃动与欧美图像小说二次元动画的清冷优雅气质冲突
