...
3. **风格统一** — 所有道具必须符合赛博朋克海外短剧世界观，无违和元素
...
| R1 | 必须指定「纯净中性灰背景」 |
| R2 | 必须明确道具材质与工艺 |
| R3 | 道具造型必须符合赛博朋克海外短剧世界观 |
| R4 | 必须包含「二次元动画风格」关键词（anime style / cel shading） |
| R5 | 必须包含景深特征（shallow depth of field / vignette 至少一项），保持动画霓虹赛璐璐风格 |
